...
public class Ex21DDayEx extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ex21_dday_layout);
        ...
        View.OnClickListener clickListener = new View.OnClickListener() {
            ...
            public void onClick(View a_view) {
                ...
                DatePickerDialog dialog = new DatePickerDialog(Ex21DDayEx.this, mDateSetListener, year, month, day);
                dialog.show();
            }
        };
